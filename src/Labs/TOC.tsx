...
export default function TOC() {
  ...
  return (
    <ul className="nav nav-pills" id="wd-toc">
      ...
      <li className="nav-item"><a id="wd-a6" href="#/Labs/Lab6"
          className={`nav-link ${pathname.includes("Lab6") ? "active" : ""}`}>Lab 6</a></li>
      <li className="nav-item"><a id="wd-k" href="#/Kambaz" className="nav-link">Kambaz</a></li>
      <li className="nav-item"><a id="wd-github" href="https://github.com/elizabeth-mcdowell/kambaz-react-web-app" target="_blank"
